	...
	<div id="personaldetil">
		...
		<div id="order">
			<a href="GetOrderInfo">全部订单</a> <a href="GetOrderInfo?orderState=待处理">待处理</a> <a
				...
				href="GetOrderInfo?orderState=待审核"><span
				style="color: red; font-weight: bold">待审核</span></a>
		</div>
			...
			<div id="orderdetile">
				...
				<p align="center">
					...
					<c:choose>
						...
						<c:otherwise>
							<a href="GetOrderByState?page=1&orderState=待审核">首页</a>
							<a
								href="GetOrderByState?page=${OrderInfo.curPage-1 }&orderState=待审核">上一页</a>
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${OrderInfo.curPage == OrderInfo.totalPages }">下一页 尾页</c:when>
						<c:otherwise>
							<a href="GetOrder?page=${OrderInfo.curPage+1 }&orderState=待审核">下一页</a>
							<a href="GetOrder?page=${OrderInfo.totalPages }&orderState=待审核">尾页</a>
						</c:otherwise>
					</c:choose>
				</p>
			</div>
